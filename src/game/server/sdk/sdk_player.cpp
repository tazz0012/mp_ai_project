...
void CSDKPlayer::MoveToNextIntroCamera()
{
	...
	// m_pIntroCamera = gEntList.FindEntityByClassname(m_pIntroCamera, "info_player_deathmatch"); // R_Yell - changed spawn entity name
	m_pIntroCamera = gEntList.FindEntityByClassname(m_pIntroCamera, "info_player_blue");
